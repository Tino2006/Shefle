...
export default function SignupForm() {
  ...
  const handleOAuthSignIn = async (provider: "google" | "apple") => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Social signup failed");
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Get started with brand protection</p>
          </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  try {
                    if (v.trim()) sessionStorage.setItem(REFERRAL_STORAGE_KEY, v.trim());
        ...
        <p className="text-center text-xs text-gray-400 mt-6">Secure access. Your data is protected.</p>
      </div>
    </div>
  );
}
