      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          ...
          {stats.pendingBrands > 0 && (
            <Link
              className="text-xs text-red-800 hover:text-red-900 mt-2 inline-block"
              href="/admin/brands"
            >
              Review now →
            </Link>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-1">
            {stats.pendingPortfolioTrademarks}
          </h3>
          ...
          <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {stats.pendingBrands} pending approvals
                  </p>
                </div>
              </div>
              <svg
                className="w-5 h-5 text-gray-400 group-hover:text-red-800"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">
                    Review Portfolio Trademarks
                  </p>
                  <p className="text-sm text-gray-500">
                    {stats.pendingPortfolioTrademarks} pending approvals
                  </p>
                </div>
              </div>
              <svg
