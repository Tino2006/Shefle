...
export default function Home() {
  ...
  return (
    <section className="relative flex w-full flex-1 flex-col justify-center overflow-hidden bg-gradient-to-b from-red-50/50 via-white to-white">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1600px] px-4 py-4 lg:px-6 lg:py-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 mb-4 border border-gray-300 rounded-full">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl lg:text-7xl font-bold text-red-900 mb-3 max-w-4xl leading-tight">
            Protect Your Brand
          </h1>

          {/* Description */}
          <p className="text-base lg:text-lg text-gray-600 mb-5 max-w-3xl leading-relaxed">
